...
LPSTR NazwaKlasy = "ActiveWindows";
MSG Komunikat;
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
    ...
    {
        MessageBox(NULL, "Error RegisterClassEx", "Activate Windows 10/11", MB_ICONEXCLAMATION);
        PostQuitMessage(0);
    	return 0;
    }
    ...
    if(hwnd == NULL)
    {
        MessageBox(NULL, "hwnd == NULL", "Activate Windows 10/11", MB_ICONEXCLAMATION);
        PostQuitMessage(0);
    	return 0;
    }
